...
SWEP.WorldModel = "models/carlsmei/escapefromtarkov/medical/alusplint.mdl"
...
SWEP.WorldAng = Angle(0,-25,75)
SWEP.WorldPos = Vector(1,0,0)
SWEP.CorrectScale = 0.5
...
function SWEP:Heal(ply)
    ...
    if SERVER then
        ...
        ply.bleed = math.Clamp(ply.bleed - math.random(100,100),0,1000)
    end
end
