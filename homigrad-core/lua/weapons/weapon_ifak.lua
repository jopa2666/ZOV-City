...
SWEP.WorldModel = "models/carlsmei/escapefromtarkov/medical/ifak.mdl"
...
function SWEP:Heal(ply)
    ...
    if SERVER then
        ...
        ply:SetHealth(math.Clamp(ply:Health() + math.random(4,9),0,ply:GetMaxHealth()))
        ply.bleed = math.Clamp(ply.bleed - math.random(13,18),0,1000)
    end
end
