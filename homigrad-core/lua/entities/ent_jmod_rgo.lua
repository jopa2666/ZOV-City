...
ENT.Author = "Jackarunda, TheOnly8Z? Lamiones3"
ENT.PrintName = "РГО"
ENT.Category = "JMod - Homigrad"
ENT.Spawnable = true
ENT.Model = "models/weapons/arc9/darsu_eft/w_rgo.mdl"
ENT.Material = "models/weapons/arc9/darsu_eft/grenades/weapon_grenade_rgo_lod0"
ENT.MiniNadeDamage = 125
