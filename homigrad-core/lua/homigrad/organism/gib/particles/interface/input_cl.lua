...
net.Receive("blood particle explode",function()
	...
	DropProp("models/mosi/fnv/props/gore/gorehead04.mdl",1,pos,Angle(),dir,Vector(Rand(-180,180),Rand(-180,180),Rand(-180,180)))
	for i = 1,2 do
		dir:Rotate(Angle(Rand(-75,75),Rand(-75,75),0))
		DropProp("models/mosi/fnv/props/gore/gorelegb02.mdl",1,pos,Angle(),dir,Vector(Rand(-180,180),Rand(-180,180),Rand(-180,180)))

		dir:Rotate(Angle(Rand(-75,75),Rand(-75,75),0))
		DropProp("models/mosi/fnv/props/gore/gorelegb03.mdl",1,pos,Angle(),dir,Vector(Rand(-180,180),Rand(-180,180),Rand(-180,180)))
	end

	dir:Rotate(Angle(Rand(-75,75),Rand(-75,75),0))
	DropProp("models/mosi/fnv/props/gore/goreleg03.mdl",1,pos,Angle(),dir,Vector(Rand(-180,180),Rand(-180,180),Rand(-180,180)))
end)
...
net.Receive("bp buckshoot",function()
	...
	timer.Simple(0.016,function()
		...
		local dir = dir:Clone():Mul(Rand(75,100))
		dir[3] = dir[3] + Rand(90,150)
		DropProp("models/mosi/fnv/props/gore/gorehead02.mdl",1,pos,Angle(),dir,Vector(Rand(-180,180),Rand(-180,180),Rand(-180,180)))
		for i = 1,2 do
			dir:Rotate(Angle(Rand(-75,75),Rand(-75,75),0))
			DropProp("models/mosi/fnv/props/gore/gorehead05.mdl",1,pos,Angle(),dir,Vector(Rand(-180,180),Rand(-180,180),Rand(-180,180)))
	
			dir:Rotate(Angle(Rand(-75,75),Rand(-75,75),0))
			DropProp("models/mosi/fnv/props/gore/gorehead06.mdl",1,pos,Angle(),dir,Vector(Rand(-180,180),Rand(-180,180),Rand(-180,180)))
		end
