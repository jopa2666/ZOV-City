-- "addons\\homigrad\\lua\\homigrad\\libraries\\core\\sh_networking.lua"
...
//Заебал ныть то что net is a nil value шлюха блять
zb = zb or {} //А НИЧО ТОТ ФАКТ ЧО
if SERVER then
